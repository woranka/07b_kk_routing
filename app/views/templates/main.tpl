...
<div id="app_top" class="header">
    <div class="home-menu pure-menu pure-menu-open pure-menu-horizontal pure-menu-fixed">
        <a class="pure-menu-heading" href=""><img src="{$conf->app_url}/img/logo.png"></a>
        <ul>
            <li class="pure-menu-selected"><a href="#app_top">Góra strony</a></li>
            <li><a href="#app_content">{$action|default:"Akcja domyślna"}</a></li>
        </ul>
    </div>
</div>
...
<div class="splash-container">
    <div class="splash">
        ...
        <p>
            <a href="#app_content" class="button-success pure-button">{$button|default:"Przycisk domyślny"}</a>
        </p>
    </div>
</div>
